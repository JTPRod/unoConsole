...
namespace UnoConsoleApp
{
    internal class Deck
    {
        private static Card[] allCards = [new Card("Red", "1"), new Card("Red", "2"), new Card("Red", "3"), new Card("Red", "4"), new Card("Red", "5"), new Card("Red", "6"), new Card("Red", "7"), new Card("Red", "8"), new Card("Red", "9"), new Card("Red", "0"), new Card("Red", "Skip"), new Card("Red", "DrawTwo"),
                                          new Card("Yellow", "1"), new Card("Yellow", "2"), new Card("Yellow", "3"), new Card("Yellow", "4"), new Card("Yellow", "5"), new Card("Yellow", "6"), new Card("Yellow", "7"), new Card("Yellow", "8"), new Card("Yellow", "9"), new Card("Yellow", "0"), new Card("Yellow", "Skip"), new Card("Yellow", "DrawTwo"),
                                          new Card("Green", "1"), new Card("Green", "2"), new Card("Green", "3"), new Card("Green", "4"), new Card("Green", "5"), new Card("Green", "6"), new Card("Green", "7"), new Card("Green", "8"), new Card("Green", "9"), new Card("Green", "0"), new Card("Green", "Skip"), new Card("Green", "DrawTwo"),
                                          new Card("Blue", "1"), new Card("Blue", "2"), new Card("Blue", "3"), new Card("Blue", "4"), new Card("Blue", "5"), new Card("Blue", "6"), new Card("Blue", "7"), new Card("Blue", "8"), new Card("Blue", "9"), new Card("Blue", "0"), new Card("Blue", "Skip"), new Card("Blue", "DrawTwo"),
                                          new Card("Red", "1"), new Card("Red", "2"), new Card("Red", "3"), new Card("Red", "4"), new Card("Red", "5"), new Card("Red", "6"), new Card("Red", "7"), new Card("Red", "8"), new Card("Red", "9"), new Card("Red", "Skip"), new Card("Red", "DrawTwo"),
